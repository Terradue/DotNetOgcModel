...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("identification", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Identification : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("IdentifierList")]
        public IdentificationIdentifierList IdentifierList { get; set; }
