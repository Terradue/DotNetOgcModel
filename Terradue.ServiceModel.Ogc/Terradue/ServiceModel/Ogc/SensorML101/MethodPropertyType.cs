...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("method", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class MethodPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ProcessMethod")]
        public ProcessMethodType ProcessMethod { get; set; }
