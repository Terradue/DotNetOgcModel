...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("parameters", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Parameters : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ParameterList")]
        public ParametersParameterList ParameterList { get; set; }
