...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("outputs", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Outputs : IAssociationAttributeGroup
    {
        /// <remarks/>
        public OutputsOutputList OutputList { get; set; }
