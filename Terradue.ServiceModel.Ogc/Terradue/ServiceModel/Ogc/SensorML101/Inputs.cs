...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("inputs", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Inputs : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("InputList")]
        public InputsInputList InputList { get; set; }
