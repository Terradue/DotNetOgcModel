...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("components", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Components : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlArrayItemAttribute("component", IsNullable = false)]
        [System.Xml.Serialization.XmlArrayAttribute("ComponentList", IsNullable = false)]
        public Collection<ComponentsComponent> ComponentList { get; set; }
