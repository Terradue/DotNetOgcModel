...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("interface", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Interface : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("InterfaceDefinition")]
        public InterfaceDefinition InterfaceDefinition { get; set; }
