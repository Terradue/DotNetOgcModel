...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("onlineResource", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class OnlineResource : IAssociationAttributeGroup
    {
