...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("positions", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Positions : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("PositionList")]
        public PositionsPositionList PositionList { get; set; }
