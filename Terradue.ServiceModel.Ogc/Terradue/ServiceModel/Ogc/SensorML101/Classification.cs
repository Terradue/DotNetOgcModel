...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("classification", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Classification : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ClassifierList")]
        public ClassificationClassifierList ClassifierList { get; set; }
