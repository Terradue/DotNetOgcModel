...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    public class ProcessMethodTypeImplementation : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ImplementationCode", Type = typeof(ProcessMethodTypeImplementationImplementationCode))]
        [System.Xml.Serialization.XmlElementAttribute("ProcessChain", Type = typeof(ProcessChainType))]
