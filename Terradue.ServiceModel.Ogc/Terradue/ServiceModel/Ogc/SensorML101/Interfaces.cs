...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("interfaces", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Interfaces : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("InterfaceList")]
        public InterfacesInterfaceList InterfaceList { get; set; }
