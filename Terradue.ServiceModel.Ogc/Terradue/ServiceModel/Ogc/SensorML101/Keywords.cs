...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("keywords", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Keywords : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("KeywordList")]
        public KeywordsKeywordList KeywordList { get; set; }
