...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("documentation", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Documentation : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Document", Type = typeof(Document))]
        [System.Xml.Serialization.XmlElementAttribute("DocumentList", Type = typeof(DocumentList))]
