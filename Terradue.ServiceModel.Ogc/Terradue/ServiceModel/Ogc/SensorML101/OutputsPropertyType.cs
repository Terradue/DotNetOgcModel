...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    public class OutputsPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("OutputList")]
        public AbstractListType OutputList { get; set; }
