...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("contact", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Contact : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ContactList", Type = typeof(ContactList))]
        [System.Xml.Serialization.XmlElementAttribute("Person", Type = typeof(Person))]
        [System.Xml.Serialization.XmlElementAttribute("ResponsibleParty", Type = typeof(ResponsibleParty))]
