...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("characteristics", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Characteristics : IAssociationAttributeGroup
    {
        /// <remarks/>
