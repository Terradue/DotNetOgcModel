...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("location", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class Location : IAssociationAttributeGroup
    {
        /// <remarks/>
        ...
        public AbstractGeometricPrimitiveType Item { get; set; }
