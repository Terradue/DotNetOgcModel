...
namespace Terradue.ServiceModel.Ogc.SensorML101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("legalConstraint", Namespace = "http://www.opengis.net/sensorML/1.0.1", IsNullable = false)]
    public class LegalConstraint : IAssociationAttributeGroup
    {
        /// <remarks/>
