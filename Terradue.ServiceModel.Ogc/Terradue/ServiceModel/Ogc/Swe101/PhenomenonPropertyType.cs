...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class PhenomenonPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ConstrainedPhenomenon", Type = typeof(ConstrainedPhenomenonType))]
        [System.Xml.Serialization.XmlElementAttribute("CompositePhenomenon", Type = typeof(CompositePhenomenonType))]
        [System.Xml.Serialization.XmlElementAttribute("Phenomenon", Type = typeof(PhenomenonType))]
