...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("DataRecord", Namespace = "http://www.opengis.net/swe/1.0.1", IsNullable = false)]
    public class DataRecordType : AbstractDataRecordType
    {
        /// <remarks/>
        public DataRecordType()
        {
            this.Xmlns = new XmlSerializerNamespaces();
            //this.Xmlns.Add(string.Empty, "http://www.opengis.net/swe/1.0.1");
        ...
        private Collection<DataComponentPropertyType> _fields = new Collection<DataComponentPropertyType>();
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("field")]
        public Collection<DataComponentPropertyType> Fields
        {
            get
            {
                return this._fields;
