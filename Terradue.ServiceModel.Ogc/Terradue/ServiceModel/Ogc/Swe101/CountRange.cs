...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("CountRange", Namespace = "http://www.opengis.net/swe/1.0.1", IsNullable = false)]
    public class CountRange : AbstractDataComponentType
    {
        /// <remarks/>
