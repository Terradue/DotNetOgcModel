...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public abstract class AbstractConditionalTypeCondition : IAssociationAttributeGroup
    {
        /// <remarks/>
        ...
        [System.Xml.Serialization.XmlElementAttribute("Curve", Type = typeof(CurveType), Namespace = "http://www.opengis.net/swe/1.0.1")]
        ...
        [System.Xml.Serialization.XmlElementAttribute("Envelope", Type = typeof(EnvelopeType), Namespace = "http://www.opengis.net/swe/1.0.1")]
        [System.Xml.Serialization.XmlElementAttribute("Vector", Type = typeof(VectorType), Namespace = "http://www.opengis.net/swe/1.0.1")]
