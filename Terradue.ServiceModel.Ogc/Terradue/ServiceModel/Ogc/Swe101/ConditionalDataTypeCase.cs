...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class ConditionalDataTypeCase : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ConditionalValue")]
        public ConditionalValueType ConditionalValue { get; set; }
