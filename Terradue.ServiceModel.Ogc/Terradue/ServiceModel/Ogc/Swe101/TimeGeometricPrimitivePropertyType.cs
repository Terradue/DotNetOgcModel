...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class TimeGeometricPrimitivePropertyType : AbstractTimeObjectType, IAssociationAttributeGroup
    {
        /// <remarks/>
        ...
        public AbstractTimeGeometricPrimitiveType TimeGeometric { get; set; }
