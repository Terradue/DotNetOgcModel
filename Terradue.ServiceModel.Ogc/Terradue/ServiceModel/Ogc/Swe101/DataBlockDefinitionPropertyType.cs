...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class DataBlockDefinitionPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("DataBlockDefinition")]
        public DataBlockDefinitionType DataBlockDefinition { get; set; }
