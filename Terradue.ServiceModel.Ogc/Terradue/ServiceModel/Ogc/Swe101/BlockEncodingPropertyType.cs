...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class BlockEncodingPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("BinaryBlock", Type = typeof(BinaryBlock))]
        [System.Xml.Serialization.XmlElementAttribute("StandardFormat", Type = typeof(StandardFormat))]
        [System.Xml.Serialization.XmlElementAttribute("TextBlock", Type = typeof(TextBlock))]
        [System.Xml.Serialization.XmlElementAttribute("XMLBlock", Type = typeof(XMLBlockType))]
        public AbstractEncodingType Item { get; set; }
