...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class MultiplexedStreamFormatPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("MultiplexedStreamFormat")]
        public MultiplexedStreamFormatType MultiplexedStreamFormat { get; set; }
