...
namespace Terradue.ServiceModel.Ogc.Swe101
{
    ...
    public class AllowedTimesPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("AllowedTimes")]
        public AllowedTimes AllowedTimes { get; set; }
