...
namespace Terradue.ServiceModel.Ogc.Om10
{
    ...
    public class CalculationProcessPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("CalculationProcess")]
        public CalculationProcessType CalculationProcess { get; set; }
