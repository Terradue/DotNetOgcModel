...
namespace Terradue.ServiceModel.Ogc.Om10
{
    ...
    public class ObservationProcessPropertyType : IAssociationAttributeGroup
    {
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Instrument", typeof(InstrumentType))]
        [System.Xml.Serialization.XmlElementAttribute("ObservationProcess", typeof(ObservationProcessType))]
        public ObservationProcessType Item { get; set; }
