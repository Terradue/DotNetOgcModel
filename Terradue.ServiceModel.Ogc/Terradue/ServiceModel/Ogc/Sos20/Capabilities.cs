...
namespace Terradue.ServiceModel.Ogc.Sos20
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://www.opengis.net/sos/2.0", IncludeInSchema = true)]
    ...
    public class Capabilities : CapabilitiesBaseType
    {
        ...
        /// </summary>
        [System.Xml.Serialization.XmlElement(ElementName = "filterCapabilities")]
        ...
        public CapabilitiesContents Contents { get; set; }

        /// <summary>
        /// Gets information about the observation offerings.
        /// </summary>
        [System.Xml.Serialization.XmlElement(ElementName = "extensions")]
