...
namespace Terradue.ServiceModel.Ogc.Sos10
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("InsertObservationResponse", Namespace = "http://www.opengis.net/sos/1.0", IsNullable = false)]
    public class InsertObservationResponse
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("AssignedObservationId", DataType = "anyURI")]
        public string AssignedObservationId { get; set; }
    }
}
