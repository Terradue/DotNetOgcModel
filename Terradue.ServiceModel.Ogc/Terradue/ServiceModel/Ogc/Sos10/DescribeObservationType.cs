...
{
    /// <summary>
    /// Specifies a request to perform an operation to request detailed information concerning hard typed observation schemas.
    /// </summary>
    ...
    [System.Xml.Serialization.XmlRootAttribute("DescribeObservationType", Namespace = "http://www.opengis.net/sos/1.0", IsNullable = false)]
    public class DescribeObservationType : RequestBaseType
    {
        /// <summary>
        /// Creates a default instance of <see cref="DescribeObservationType"/>.
        /// </summary>
        public DescribeObservationType()
        {
        ...
        /// <summary>
        /// Gets or sets the phenomenon for which the observationType is requested.
        /// </summary>
