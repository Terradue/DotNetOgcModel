...
namespace Terradue.ServiceModel.Ogc.Sos10
{
    ...
    public class GetFeatureOfInterestLocation
    {
        /// <remarks/>
        public GetFeatureOfInterestLocation()
        {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("spatialOps", Namespace = "http://www.opengis.net/ogc")]
        public SpatialOpsType spatialOps { get; set; }
    }
}
