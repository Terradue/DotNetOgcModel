...
namespace Terradue.ServiceModel.Ogc.Sos10
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("RegisterSensor", Namespace = "http://www.opengis.net/sos/1.0", IsNullable = false)]
    public class RegisterSensor : RequestBaseType
    {
        /// <remarks/>
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("SensorDescription")]
        public System.Xml.XmlElement SensorDescription { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ObservationTemplate")]
        public ObservationTemplate ObservationTemplate { get; set; }
    }
}
